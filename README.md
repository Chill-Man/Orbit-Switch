...
2. Выберите подходящий вариант:
   ...
   | Файл | Назначение |
   |---|---|
   | `Orbit-Switch-1.0.1-Windows-x64-x86-Setup.exe` | Обычная установка с автоматическим выбором x64/x86, ярлыками и деинсталлятором |
   | `Orbit-Switch-1.0.1-Windows-x64-Portable.exe` | Один x64 EXE: скачайте и запускайте без установки |
